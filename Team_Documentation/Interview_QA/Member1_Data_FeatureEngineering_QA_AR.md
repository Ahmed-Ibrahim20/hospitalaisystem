...
- `d:\hospital-ai-system\AI-Powered\data\data_processing.py` - معالجة البيانات الأولية وتنظيفها
- `d:\hospital-ai-system\AI-Powered\data\feature_engineering.py` - هندسة الميزات الطبية وإنشاء 30 ميزة جديدة
- `d:\hospital-ai-system\AI-Powered\data\data_quality.py` - ضمان جودة البيانات والتحقق من التكامل
- `d:\hospital-ai-system\AI-Powered\data\diabetes_binary_5050split_health_indicators_BRFSS2015.csv` - مصدر البيانات الأساسي من BRFSS 2015

**شرح الملفات:**

- **data_processing.py**: يقوم بتنظيف البيانات، إزالة القيم المفقودة، والتأكد من جودة البيانات قبل المعالجة
- **feature_engineering.py**: ينشئ ميزات طبية جديدة مثل BMI ratios و risk flags بناءً على أدلة طبية وربطنهاا بي api عشان ندخل بيانات دي من انترفيس الي بتتعرض في لارفيل
- **data_quality.py**: يتحقق من جودة البيانات في الوقت الفعي ويرسل تنبيهات عند وجود مشاكل
- **البيانات**: تحتوي على 253,680 سجل من مسح BRFSS 2015 مع 21 ميزة أساسية
...
```python
## 📊 **أسئلة Data Source وImbalance Handling**
