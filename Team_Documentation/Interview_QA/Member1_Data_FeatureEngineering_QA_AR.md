...
- `d:\hospital-ai-system\AI-Powered\models\preprocessing.py` - معالجة البيانات الأولية وتنظيفها
- `d:\hospital-ai-system\AI-Powered\models\advanced_features.py` - هندسة الميزات الطبية وإنشاء 30 ميزة جديدة
- `d:\hospital-ai-system\AI-Powered\data\raw\diabetes_binary_5050split_health_indicators_BRFSS2015.csv` - مصدر البيانات الأساسي من BRFSS 2015

**شرح الملفات:**

- **preprocessing.py**: يقوم بتنظيف البيانات، إزالة القيم المفقودة، والتأكد من جودة البيانات قبل المعالجة
- **advanced_features.py**: ينشئ ميزات طبية جديدة مثل BMI ratios و risk flags بناءً على أدلة طبية
