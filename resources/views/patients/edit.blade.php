...
<div class="page-header text-center py-4 mb-4">
    ...
    <p class="mb-0 opacity-90">تحديث بيانات المريض في النظام</p>
</div>
...
<div class="form-card card">
    ...
    <div class="form-body">
        ...
        <div class="patient-info">
            <div class="row">
                <div class="col-md-4">
                    <small class="text-muted">رقم المريض:</small>
                    <div class="fw-bold">#{{ $patient->id }}</div>
                </div>
                <div class="col-md-4">
                    <small class="text-muted">تاريخ التسجيل:</small>
                    <div class="fw-bold">{{ $patient->created_at->format('Y/m/d H:i') }}</div>
                </div>
                <div class="col-md-4">
                    <small class="text-muted">آخر تحديث:</small>
                    <div class="fw-bold">{{ $patient->updated_at->format('Y/m/d H:i') }}</div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror"
                            ...
                            name="address"
                            rows="3"
                            placeholder="عنوان المريض (اختياري)">{{ old('address', $patient->address) }}</textarea>
                        @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
