...
@section('title', 'إضافة زيارة طبية جديدة')
...
<div class="page-header text-center py-4 mb-4">
    ...
    <p class="mb-0 opacity-90">تسجيل زيارة طبية جديدة في النظام</p>
</div>
...
<div class="info-card">
    <div class="d-flex align-items-center">
        ...
        <div>
            ...
            <span>يجب اختيار المريض والطبيب وتحديد تاريخ ووقت الزيارة بدقة. لا يمكن تحديد مواعيد في الماضي.</span>
        </div>
    </div>
</div>
