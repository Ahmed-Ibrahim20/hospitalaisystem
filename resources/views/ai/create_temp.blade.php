...
<script>
    ...
    function fillExample3() {
        ...
        document.getElementById('blood_pressure_systolic').value = 145;
        document.getElementById('blood_pressure_diastolic').value = 92;
        document.getElementById('blood_sugar_fasting').value = 95;
        document.getElementById('blood_sugar_random').value = 120;
        document.getElementById('high_bp_1').checked = true;
        document.getElementById('phys_activity_0').checked = true;
        document.getElementById('fruits_0').checked = true;
        document.getElementById('veggies_0').checked = true;
        document.getElementById('gen_health').value = 3;
        document.getElementById('ment_health').value = 5;
        document.getElementById('phys_health').value = 8;
